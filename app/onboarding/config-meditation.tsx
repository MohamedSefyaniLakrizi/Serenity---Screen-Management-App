...
export default function ConfigMeditationScreen() {
  ...
  const [titleAnim, subtitleAnim, stepperAnim, infoAnim, buttonAnim] =
  ...
  const accentColor = theme.habitAccent.meditation;
    ...
    <SafeAreaView style={s.container} edges={["top", "bottom"]}>
      ...
      <View style={s.content}>
        ...
        <Animated.Text style={[s.subtitle, subtitleAnim]}>
          How long do you want to meditate each day?
        </Animated.Text>
