  ...
  return (
    <Animated.View style={[styles(theme).container, screenFade]}>
      ...
      <View style={styles(theme).progressBarContainer}>
        <View style={styles(theme).progressBarWrapper}>
          ...
          <View style={styles(theme).progressBarBackground}>
            <View style={[styles(theme).progressBarFill, { width: '20%' }]} />
          </View>
        </View>
      </View>
      ...
      >
        ...
        <Animated.Text style={[styles(theme).title, titleAnimation]}>Pause and reflect</Animated.Text>
        ...
        <Animated.Text style={[styles(theme).subtitle, subtitleAnimation]}>before jumping into distracting apps</Animated.Text>
      </View>
      </ScrollView>
      ...
      <View style={styles(theme).actions}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => router.push('/onboarding/mindful-sessions')}
          activeOpacity={0.8}
        >
